...
function showResultG() {
	...
	for (j=1; j<=G_Peo.length; j++) {
		...
		switch(j) {
		case 1: str += "<tr><th colspan=3>モーニング娘。'17<\/th><\/tr>";break;
		...
		case 7: str += "<tr><th colspan=3>ソロ(ハロプロ所属)<\/th><\/tr>";break;
		case 8: str += "<tr><th colspan=3>ハロプロ研修生<\/th><\/tr>";break;
		case 9: str += "<tr><th colspan=3>ハロプロ研修生北海道<\/th><\/tr>";break;
		case 10: str += "<tr><th colspan=3>LoVendoЯ<\/th><\/tr>";break;
		case 11: str += "<tr><th colspan=3>PINK CRES.<\/th><\/tr>";break;
		case 12: str += "<tr><th colspan=3>チャオベッラチンクエッティ<\/th><\/tr>";break;
		case 13: str += "<tr><th colspan=3>ソロ<\/th><\/tr>";break;
		case 14: str += "<tr><th colspan=3>アップアップガールズ(仮)<\/th><\/tr>";break;
		case 15: str += "<tr><th colspan=3>Bitter & Sweet<\/th><\/tr>";break;
		case 16: str += "<tr><th colspan=3>Lovelys<\/th><\/tr>";break;
		case 17: str += "<tr><th colspan=3>モーニング娘。ＯＧ<\/th><\/tr>";break;
		case 18: str += "<tr><th colspan=3>Berryz工房ＯＧ<\/th><\/tr>";break;
		case 19: str += "<tr><th colspan=3>℃-uteＯＧ<\/th><\/tr>";break;
		case 20: str += "<tr><th colspan=3>その他<\/th><\/tr>";break;
		case 21: str += "<tr><th colspan=3>アップアップガールズ(２)<\/th><\/tr>";break;
		case 22: str += "<tr><th colspan=3>アップアップガールズ(プロレス)<\/th><\/tr>";break;
		}		
		str += "<tr><th>順位<\/th><th>名前<\/th><th>得点<\/th><\/tr>";
		...
		switch(j) {
			...
			case 22: if(Members[i].id<Gcol[20]){continue;}else{break;}
		}		
		s='id="iro'+i+'"';
		str += "<tr>";
